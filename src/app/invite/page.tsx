            ...
            <div className="flex flex-raw flex-wrap justify-center">
                ...
                <div className="bg-[#414141] p-5 flex rounded m-5">
                    ...
                    <div className="flex flex-col justify-around ml-5 text-center">
                        ...
                        <Link href="https://discord.com/oauth2/authorize?client_id=1140130682094497823" target="_blank" className="text-[#5c9ae0] w-[160px] bg-[#3d4c61] p-3 rounded hover:bg-[#475870] transition-colors duration-150">Invite HStudio (1)</Link>
                    </div>
                </div>
            </div>
