    ...
    if (!version0 || !version1) {
        fetch("https://api.hewkawar.xyz/app/hstudio/info")
            ...
            .then(data => {
                ...
                hstudioVersion0.innerHTML = `(Version ${data.hstudio[0].version})`;
                hstudioVersion1.innerHTML = `(Version ${data.hstudio[1].version})`;
            })
            .catch(error => {
        ...
        hstudioVersion0.innerHTML = `(Version ${version0})`;
        hstudioVersion1.innerHTML = `(Version ${version1})`;
    }
}
